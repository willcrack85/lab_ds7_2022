    ...
    <body class="d-flex flex-column h-100">
        ...
        <main role="main" class="flex-shrink-0">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="mt-5">DS7 - Laboratorio 6.1</h1>
                            ...
                            <div class="row">
                                <div class='jumbotron-wc1 border border-white col-md-12'>
                                    ...
                                    <div class="jumbotron-wc2 bg-info border border-white">
                                        ...
                                        echo "<dt class='col-sm-5'>El identificado del Cliente 1 es: </dt>";
                                        echo "<dd class='col-sm-7'>" . $Cliente1->dame_numero() . "</dd>";
                                        echo "</dl>";
                                        echo "<dl class='row'>";
                                        echo "<dt class='col-sm-5'>El identificado del Cliente 2 es: </dt>";
