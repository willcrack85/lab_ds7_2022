...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="mt-5">DS7 - Laboratorio 6.4</h1>
                                        ...
                                        <tr>
                                            <th>
                                                <div class="jumbotron-wc2 bg-info border border-white">
                                                    ...
                                                    print "<dt class='col-sm-10 text-right'>" . Foo::$mi_static . "</dt>";
                                                    echo "<dd class='col-sm-2'> value (1).</dd>";
                                                    echo "</dl>";

                                                    $foo = new Foo();
                                                    echo "<dl class='row mt-3 mb-0 text-left'>";
                                                    print "<dt class='col-sm-10 text-right'>" . $foo->staticValor() . "</dt>";
                                                    echo "<dd class='col-sm-2'> value (2).</dd>";
                                                    echo "</dl>";

                                                    echo "<dl class='row mt-3 mb-0 text-left'>";
                                                    print "<dt class='col-sm-10'>" . $foo->mi_static . "</dt>";
                                                    echo "<dd class='col-sm-2'> value (3).</dd>";
                                                    echo "</dl>";

                                                    echo "<dl class='row mt-3 mb-0 text-left'>";
                                                    print "<dt class='col-sm-10 text-right'>" . Bar::$mi_static . "</dt>";
                                                    echo "<dd class='col-sm-2'> value (4).</dd>";
                                                    echo "</dl>";

                                                    $bar = new Bar();
                                                    echo "<dl class='row mt-3 mb-0 text-left'>";
                                                    print "<dt class='col-sm-10 text-right'>" . $bar->fooStatic() . "</dt>";
                                                    echo "<dd class='col-sm-2'> value (5).</dd>";
                                                    echo "</dl>";
                                                    ?>
                                                </div>
                                            </th>
