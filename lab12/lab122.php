...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-3">DS7 - Laboratorio 12.2</h1>
                    ...
                    <div class="jumbotron-wc2 border border-white p-3 m-2">
                        <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                            ...
                            if (isset($_SESSION['var'])) {
                                ...
                                print("<div class='form-group col-md-12 text-center'>");
                                print("<a class='btn btn-danger col-md-8 col-md-offset-4' href='lab121.php' role='button'>Sesión no iniciada, ir a al Paso 1 para iniciar sesion</a>");
                                print("</div>");
                            }
                            ?>
                        </div>
