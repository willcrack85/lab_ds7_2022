...
?>
<!DOCTYPE html>
<html XMLNS="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es" class="h-100">
...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-3">DS7 - Laboratorio 13.1</h1>
            ...
            <div class="row m-1">
                <div class='jumbotron-wc1 border border-white col-md-12'>
                    <div class="shadow-lg p-3 mb-2 m-2 bg-white text-primary rounded">
                        <h1 class='text-white bg-dark text-center'>CONTADOR DE VISITAS DE COOKIES</h1>
                    </div>
