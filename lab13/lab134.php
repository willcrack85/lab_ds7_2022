...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-3">DS7 - Laboratorio 13.4</h1>
                    ...
                    <div class="jumbotron-wc2 border border-white p-3 m-2">
                        <div class="shadow-lg p-3 mb-2 mx-5 bg-white text-primary rounded">
                            ...
                            if (isset($_COOKIE["user"])) {
                                setcookie("user", "", time() - 1);  //// &nbsp; Usado para espaciar una cadena.
                                echo ("<p class='text-center'>La cookie&nbsp;" . $_COOKIE["user"] . "&nbsp;ha sido eliminada satisfactoriamente</p>");
                            } else {
                                echo ("<p class='text-center'>La cookie 'user' no existe.</p>");
                            }
                            if (isset($_COOKIE["contador"])) {
                                setcookie("contador", "", time() + 365 * 24 * 60 * 60);
                                echo ("<p class='text-center'>La cookie&nbsp;" . $_COOKIE["contador"] . "&nbsp;ha sido eliminada satisfactoriamente</p>");
                            } else {
                                echo ("<p class='text-center'>La cookie 'contador' no existe.</p>");
                            }
                            ?>
                            <div class="input-group mb-1">
                                <div class='col-md-12 text-center'>
                                    <a class='btn btn-success col-md-5 col-md-offset-4' href='lab131.php' role='button'>Volver al contador de visitas</a>
                                    <a class='btn btn-success col-md-5 col-md-offset-4' href='lab132.php' role='button'>Volver al saludo a usuario</a>
                                </div>
                            </div>
                        </div>
                        <hr>
