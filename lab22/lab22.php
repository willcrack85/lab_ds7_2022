...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-3">DS7 - Laboratorio 22</h1>
                <p class="lead">Objetivo: Crear una imagen personalizada de la imagen phpid/xampp y que incluya holamundo.php creado en la parte C de esta guía dentro de un nuevo contenedor utilizando DockerFile.</p>
                <hr class="my-4">
            </div>
        </div>
