...
<body>
    <form name="formParcial1" method="POST" action="parcial1.2B.php">
        <div class="container">
            <div class="row">
                <div class="jumbotron text-center col-md-12 col-md-auto">
                    <h1 class="display-4">DS7 - Parcial 1 (B)</h1>
                        <p class="lead">Crear una aplicación en PHP que realice una sucesión Fibonacci. La sucesión comienza con los números 0 y 1,2 y a 
